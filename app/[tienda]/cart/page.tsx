							...
							{carrito.length > 0 && (
								<div className="flex flex-col justify-center items-center min-h-[100px]">
									{tiendaLoading ? (
										...
										<button
											className="w-full block text-center px-4 py-2 font-bold rounded-lg transition-all disabled:opacity-60 mb-3"
											...
											onMouseLeave={(e) => e.currentTarget.style.backgroundColor = currentColors.buttonBg}
