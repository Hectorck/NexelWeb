...
export default function PerfilPage() {
  ...
  return (
    <div style={{ backgroundColor: currentColors.bgPrimary, color: currentColors.textPrimary }} className="min-h-screen flex flex-col items-center justify-center transition-colors px-4 py-6 sm:py-12">
      <h1 className="text-3xl font-bold mb-6" style={{ color: currentColors.textPrimary }}>Mi perfil</h1>
      <div style={{ backgroundColor: currentColors.bgSecondary }} className="rounded-xl shadow-lg p-8 flex flex-col items-center w-full max-w-md">
        {/* Foto de perfil */}
